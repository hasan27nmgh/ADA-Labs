...
n <- 5
labels5 <- c("0-4","5-9","10-14","15-19","20-24","25-29","30-34","35-39",
             "40-44","45-49","50-54","55-59","60-64","65-69","70-74","75-79",
             "80-84","85-89","90-94","95-99","100+")

n_age_groups <- length(labels5)        # 21
n_projections <- 200 / n               # 40
years <- seq(from = 2020, to = 2020 + n_projections*n, by = n)


# Get initial population vector in correct order
get_initial_pop <- function(country){
  dpop |>
    filter(region == country) |>
    mutate(age_group = factor(age_group, levels = labels5)) |>
    tidyr::complete(age_group, fill = list(pop = 0)) |>
    arrange(age_group) |>
    pull(pop)
}
